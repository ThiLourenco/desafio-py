...
class Historico:
        ...
        self._transacoes.append(
            {
                ...
                "data": datetime.fromtimestamp(datetime.now().timestamp()).strftime("%Y-%m-%d %H:%M:%S"),
            }
        )
    ...
    def transacoes_do_dia(self):
        data_atual = datetime.fromtimestamp(datetime.now().timestamp()).strftime("%Y-%m-%d %H:%M:%S")
        transacoes = []
        for transacao in self._transacoes:
...
def log_transacao(func):
    def envelope(*args, **kwargs):
        ...
        data_hora = datetime.fromtimestamp(datetime.now().timestamp()).strftime("%Y-%m-%d %H:%M:%S")
